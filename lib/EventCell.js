...
var EventCell = function (_React$Component) {
    ...
    EventCell.prototype.render = function render() {
        var _props = this.props,
            ...
            event = _props.event,
            passed = _props.event.passed,
            blacked = _props.event.blacked,
            ...
            props = _objectWithoutProperties(_props, ['className', 'event','passed','blacked', 'selected', 'isAllDay', 'eventPropGetter', 'startAccessor', 'endAccessor', 'titleAccessor', 'tooltipAccessor', 'allDayAccessor', 'slotStart', 'slotEnd', 'onSelect', 'onDoubleClick', 'eventComponent', 'eventWrapperComponent']);
        ...
        if (eventPropGetter) var _eventPropGetter = eventPropGetter(event, start, end, selected, passed, blacked),
