...
var EventCell = function (_React$Component) {
    ...
    EventCell.prototype.render = function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['className', 'event','passed', 'selected', 'isAllDay', 'eventPropGetter', 'startAccessor', 'endAccessor', 'titleAccessor', 'tooltipAccessor', 'allDayAccessor', 'slotStart', 'slotEnd', 'onSelect', 'onDoubleClick', 'eventComponent', 'eventWrapperComponent']);
        ...
        if (eventPropGetter) var _eventPropGetter = eventPropGetter(event, start, end, selected, passed),
